...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white">
      {/* Hero Section */}
      <section className="relative py-4 px-3 lg:px-6 overflow-hidden">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="relative z-10">
            ...
            {/* Banner Iklan */}
            <div className="bg-gradient-to-r px-2 from-blue-600/20 via-purple-600/20 to-pink-600/20 backdrop-blur-xl rounded-xl border border-blue-500/30 shadow-lg h-16 flex items-center justify-center mb-4">
              <div className="text-center">
                <div className="flex items-center gap-2">
                  <div className="text-2xl">📢</div>
                  <span className="text-white font-semibold flex items-center gap-1">
                    Space Iklan - Hubungi
                    <svg xmlns="http://www.w3.org/2000/svg" className="inline-block w-5 h-5 text-blue-400" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M21.944 2.506a1.5 1.5 0 0 0-1.62-.217L2.7 10.13a1.5 1.5 0 0 0 .13 2.77l4.44 1.56 1.7 5.37a1.5 1.5 0 0 0 2.38.74l2.36-1.93 3.7 2.73a1.5 1.5 0 0 0 2.36-.86l3.13-15.06a1.5 1.5 0 0 0-.96-1.97ZM9.6 17.13l-1.36-4.3 7.98-6.98-9.6 6.1-4.44-1.56 17.62-7.84-3.13 15.06-3.7-2.73-2.36 1.93Z"/>
                    </svg>
                    @business_upstream
                  </span>
                </div>
